...
#include <intrin.h>
#include <stdexcept>
static inline void cpuid(int32_t out[4], int32_t eax, int32_t ecx) {
...
#include <cpuid.h>
#include <stdint.h>
static inline void cpuid(int32_t cpuInfo[4], int32_t eax, int32_t ecx) {
...
static inline bool AVX512Capable() {
...
class BaseFilterFunctor {
 public:
    virtual bool operator()(mqohnswlib::labeltype id) { return true; }
